...
class CreditController(
    ...
    @PostMapping
    fun createCredit(@RequestBody @Valid creditDto: CreditDto): ResponseEntity<String> {
    ...
    @GetMapping
    fun findAllCustomerCredit(@RequestParam(value = "customerId") customerId: Long): ResponseEntity<List<CreditViewList>> {
